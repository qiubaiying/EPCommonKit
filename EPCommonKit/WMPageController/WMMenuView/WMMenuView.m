...
- (CGFloat)progressHeight {
    switch (self.style) {
        ...
        case WMMenuViewStyleFloodHollow:
            // BY Fix :return WMDEFAULT_VAULE(_progressHeight, ceil(self.frame.size.height * 0.8));
            return WMDEFAULT_VAULE(_progressHeight, ceil(self.frame.size.height * 1.0));
        default:
...
//            return CGRectMake(0, 0, self.scrollView.contentSize.width, self.progressHeight);
        }
    }
}
