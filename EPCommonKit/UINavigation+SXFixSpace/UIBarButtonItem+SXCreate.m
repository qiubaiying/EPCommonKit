...
+(UIBarButtonItem *)itemWithTarget:(id)target action:(SEL)action title:(NSString *)title {
    return [self itemWithTarget:target action:action title:title font:nil titleColor:[UIColor colorWithRed:110/255.f green:110/255.f blue:110/255.f alpha:1.0] highlightedColor:nil titleEdgeInsets:UIEdgeInsetsZero];
}
